...
nohup python run.py \
  exp_id="dpot_case1" \
  goal="solve Navier-Stokes Equations 2D incompressible fluid turbulence simulation" \
  data_dir="/data2/xinyi/ns_0.1_0.01.h5" \
  exp_name="dpot_case1-h5-prediction-with-globalmem" \
